...
def addsongs():
    ...
    for s in temp_song:
        s=s.replace("C:/Users/ASUS/Codeclause/Music/","")
...
def Play():
    ...
    song=f'C:/Users/ASUS/Codeclause/Music/{song}'
...
def Previous():
    ...
    temp2=f'C:/Users/ASUS/Codeclause/Music/{temp2}'
...
def Next():
    ...
    temp=f'C:/Users/ASUS/Codeclause/Music/{temp}'
